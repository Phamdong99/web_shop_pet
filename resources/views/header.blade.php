<header>
    ...
    <div class="container-menu-desktop">
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <!-- Logo desktop -->
                <a href="#" class="logo">
                    <img src="/template/images/icons/Dola1.png" alt="IMG-LOGO">
                </a>
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        ...
                        {!! $menusHtml !!}
                        <li>
                            <a href="https://vnexpress.net/tag/cho-meo-153981">Tin tức</a>
                        </li>
                        <li>
                            <a href="/information">Thông tin</a>
                        </li>
                        <li>
                            <a href="/contact_show">Liên hệ</a>
                        </li>
    ...
    <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
        <div class="container-search-header">
            ...
            <form class="wrap-search-header flex-w p-l-15" action="{{route('member.search')}}" method="get">
